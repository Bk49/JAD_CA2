...
<link rel="stylesheet" type="text/css" href="./CA1/css/Home.css?v=1">
...
<%
	...
	out.print("<h2 class=\"text-warning text-center\">Search for "+request.getAttribute("searchStr")+"</h2>");
        ...
        "<div class=\"col mb-4\">" +
          "<div class=\"card cardProduct \">" +
		      "<a href='./GoProductDetail?productId="+product.getProductId()+"'>"+
                "<img src='./CA1"+product.getImageLocation()+"' class=\"card-img-top card-all-cat mx-auto\" alt=\"...\">" +
            "<div class=\"card-body \">" +
...
<%
	...
	noOfProducts = (double)request.getAttribute("productCount");
        ...
        for(int i = 0 ; i < Pages; i++){
   			 out.print("<a  class='active' href='SearchProduct?searchStr="+request.getAttribute("searchStr")+"&pg="+(i+1)+"'>"+ (i+1) +"</a>");
